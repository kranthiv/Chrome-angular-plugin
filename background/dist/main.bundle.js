...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_context_menu_service__ = __webpack_require__(79);
...
AppComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__services_context_menu_service__["a" /* ContextMenuService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_context_menu_service__["a" /* ContextMenuService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_context_menu_service__["a" /* ContextMenuService */]) === "function" && _a || Object])
], AppComponent);
...
var ContextMenuService = (function () {
    ...
    ContextMenuService.prototype.addContextMenu = function () {
        this.readMenu();
        this.menuItems.forEach(function (item) {
            var id = chrome.contextMenus.create(item);
        });
    };
    ContextMenuService.prototype.readMenu = function () {
        this.menuItems.push({
            'contexts': ["selection"],
    ...
    ContextMenuService.prototype.sendMessage = function (info, tab) {
        chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
            console.log(tabs);
            chrome.tabs.sendMessage(tabs[0].id, { info: info, tab: tab });
        });
    };
